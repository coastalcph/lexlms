#!/usr/bin/env python
# coding=utf-8
""" Finetuning models on CNLI (e.g. Bert, RoBERTa, LEGAL-BERT)."""
...
def main():
    ...
    config = AutoConfig.from_pretrained(
        ...
        finetuning_task=data_args.task,
        cache_dir=model_args.cache_dir,
    ...
    data_collator = DataCollatorForSeq2Seq(tokenizer=tokenizer, model=model,
        ...
        if model_args.seq2seq else default_data_collator
