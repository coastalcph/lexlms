...
def main():
    ...
    if training_args.do_train:
        train_dataset = load_dataset("lexlms/lex_glue_v2", 'ledgar', split="train",
                                     cache_dir=model_args.cache_dir)

    if training_args.do_eval:
        eval_dataset = load_dataset("lexlms/lex_glue_v2", 'ledgar', split="validation",
                                    cache_dir=model_args.cache_dir)
    ...
    def preprocess_function(examples):
        ...
        batch["labels"] = [label_list.index(label) for label in examples["label"]]
